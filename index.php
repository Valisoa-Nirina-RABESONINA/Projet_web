...
<head>
    <meta charset="utf-8">
    <title>Papao Site</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="" name="keywords">
    <meta content="" name="description">

    <title>Wiki PAPAO</title>

    <link rel="stylesheet" href="wiki/css/wiki_css.css">
    <!-- Favicon -->
    <link href="img/favicone.jpg" rel="icon">
...
<body>
        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-dark p-0">
                <a href="index.php" class="navbar-brand">
                    <h1 class="text-white">PAPAO<span class="text-dark"></span>...</h1>
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto">
                        <a href="index.php" class="nav-item nav-link active">Fandraisana</a>
                        <a href="about.php" class="nav-item nav-link">&nbsp; </a>
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Boky</a>
                            <div class="dropdown-menu bg-light mt-2">
                                <a href="#" class="dropdown-item">Mathématique</a>
                                <a href="#" class="dropdown-item">Physique</a>
                                <a href="#" class="dropdown-item">Français</a>
                                <a href="#" class="dropdown-item">Anglais</a>
                                <a href="#" class="dropdown-item">Malagasy</a>
                                <a href="#" class="dropdown-item" onclick="loadPage('wiki/index.php')">wiki</a>
                            </div>
                        </div>
						
						<div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">DBA</a>
                            <div class="dropdown-menu bg-light mt-2">
                                <a href="dba_monitoring/index.php" class="dropdown-item">Monitoring</a>
                                <a href="#" class="dropdown-item">Administration</a>
                                <a href="#" class="dropdown-item">Lovia</a>
                            </div>
                        </div>
						<div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Multimedia</a>
                            <div class="dropdown-menu bg-light mt-2">
                                <a href="contenu/playlist.php" class="dropdown-item">Audios</a>
                                <a href="#" class="dropdown-item">Videos</a>
                                <a href="#" class="dropdown-item">Photos</a>
                            </div>
                        </div>
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Jeux</a>
                            <div class="dropdown-menu bg-light mt-2">
                                <a href="#" class="dropdown-item">Adventure</a>
                                <a href="#" class="dropdown-item">Course</a>
                                <a href="#" class="dropdown-item">FPS</a>
                                <a href="#" class="dropdown-item">Arcadate</a>
                                <a href="#" class="dropdown-item">Tir</a>
                            </div>
                        </div>
    ...
    <!-- ========================================================= -->
    <!-- SCRIPTS DU MENU WIKI-->
    <!-- ========================================================= -->

    <script src="wiki/script/wiki_script.js"></script>
